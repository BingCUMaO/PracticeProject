...
public class Responder {
    ...
    public Responder(@NotNull Socket client){
        this();
        try {
    ...
    public Responder(@NotNull OutputStream os){
        this();
    ...
    private void createHeadInfo(int statusCode) {
        ...
        headInfo.append("Server:").append("BinGCU Server/0.0.1;charset=GBK").append(CRLF);
